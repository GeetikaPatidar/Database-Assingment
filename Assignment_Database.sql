# Question : Learn and implement database creation. 
			#CREATE A DATABASE SCHEME AND NAMED IT AS HOTEL MANAGEMENT SYSTEM, 
			#ACTIONS TO BE TAKEN: Create Table Customers, with the following attributes: 
			#Column 1: Cust_ID (Type - Integer) [Primary Key, Not Null] 
			#Column 2 : Cust_Name (Type - Varchar) 
			#Column 3 : Cust_City (Type - Varchar)
			#Column 4 : Cust_RoomNo (Type - Integer) 
			#Column 5: CheckIn_Time (Type - Date/Time) 
...
values (6, "shruti", "hartford", 101, "2022-07-26 10:10:10"),
 (7, "sheekha", "glastonbury", 102, "2022-07-26 11:10:10"),
 (8, "shrijee", "newbritain", 103, "2022-07-26 13:10:10"),
 (9, "varun", "milford", 104, "2022-07-26 14:10:10"),
 (10, "geetika", "newington", 105, "2022-07-26 15:10:10");
...
# Q1: Print Distinct City from Table Customers and Print Count Distinct City from Table Customers. 

select distinct(City) from customers;
select count(distinct (city)) from customers;

# Q2: Write a SQL query to get the least number of quantities and the highest number of quantities bought by the user consider the OrderDetails Table.

select MAX(quantity) as Maximum, MIN(quantity) as Minimum
from order_details;

# Q3: Print the total and an average number of quantities ordered by users, consider the OrderDetails Table.

select avg(quantity) as average, sum(quantity) as sum
from order_details;

# Q4: Print name of the product which is present at the 5th position till the 15th position from Products table, use LIMIT keyword. 

select productname
from products
limit 4,11;

# Q5: Write a SQL query for all the details of the supplier whose name consists of “A” at the second position from the Suppliers table.  

select * from suppliers
where suppliername like "_a%";

# Q6: Print the details of the customer who doesn’t stay in the USA and Canada from the Customers table. 

select * from customers
where  country != "USA" and country != "canada";

# Q7: Print the details of all the orders which were placed between the year 2020 to 2021 also print the same in descending order from the OrderDetails table.

select orders.OrderID, orders.CustomerID, orders.EmployeeID, orders.OrderDate, orders.ShipperID 
from orders inner join order_details on orders.OrderDate between '2020-01-01' and '2021-12-31' order by order_details.OrderID desc;


# Q8: Write a query to show the distinct city and their count from the Customers table. 

select distinct city, count(city) as count
from customers
group by city;

# Q9: Write a query to fetch details of all employees excluding the employees with first names, “Sanjay” and “Sonia” from the Employees table
select * from employees
where FirstName != ("sanjay" and "Sonia");

# Q10: Duplicate a table as similar to the Suppliers table and name it as SupplierDetail. 
#select * from suppliers;
...
# Q11: Delete customer details whose country is Venezuela and print the rest of the Customer table 
select * from customers;
